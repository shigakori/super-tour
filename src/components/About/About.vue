<template>
    ...
    <section class="about">
        <div class="about__content container">
                    ...
                    <defs>
                        <filter id="filter0_dddddd_7_1561" x="-73" y="0" width="729" height="611"
                            ...
                            <feColorMatrix type="matrix"
                                values="0 0 0 0 0.384314 0 0 0 0 0.281098 0 0 0 0 0.0156863 0 0 0 0.0477948 0" />
                            ...
                            <feColorMatrix type="matrix"
                                values="0 0 0 0 0.384314 0 0 0 0 0.303216 0 0 0 0 0.0156863 0 0 0 0.0686618 0" />
                            ...
                            <feColorMatrix type="matrix"
                                values="0 0 0 0 0.384314 0 0 0 0 0.347451 0 0 0 0 0.0156863 0 0 0 0.085 0" />
                            ...
                            <feColorMatrix type="matrix"
                                values="0 0 0 0 0.384314 0 0 0 0 0.281098 0 0 0 0 0.0156863 0 0 0 0.101338 0" />
                            ...
                            <feColorMatrix type="matrix"
                                values="0 0 0 0 0.384314 0 0 0 0 0.303216 0 0 0 0 0.0156863 0 0 0 0.122205 0" />
                            ...
                            <feColorMatrix type="matrix"
                                values="0 0 0 0 0.375833 0 0 0 0 0.32021 0 0 0 0 0.0281875 0 0 0 0.17 0" />
            ...
            <div class="about__info">
                <h1 class="about__title">Добро пожаловать в SUPER TOUR</h1>
                <p class="about__desc">Мы - группа любителей путешествий и приключений, которые обожают исследовать наш
                    мир. У нас много опыта в путешествиях и мы знаем многое о разных странах и культурах. Мы хотим
                    поделиться этими знаниями с вами и помочь сделать ваши путешествия незабываемыми.</p>
                <p class="about__desc-1">Наша цель - вдохновить вас на путешествия и помочь сделать осознанный выбор при
                    планировании своих приключений. Мы предлагаем полезные советы, рекомендации и информацию о разных
                    странах, чтобы помочь вам создать уникальный опыт и почувствовать аутентичность каждого места,
                    которое вы посещаете.</p>
            </div>
        </div>
    </section>
    ...
    <section class="pics">
        <div class="gallery container">
            <h2 class="gallery__title">Наша галерея изображений</h2>
            <div class="gallery__grid">
                <div class="gallery__item" v-for="(image, index) in images" :key="index" @click="openModal(index)">
    ...
    <div v-if="isModalOpen" class="modal" @click="closeModal">
        <div class="modal__content" @click.stop>
            <button class="modal__prev" @click="prevImage">❮</button>
            <img :src="images[currentImage].src" :alt="images[currentImage].alt" class="modal__image" />
            <button class="modal__next" @click="nextImage">❯</button>
        </div>
    </div>
    ...
    <section class="company">
        <h1 class="company__title">Компания SUPER TOUR</h1>
        <div class="company__content container">
            <div class="company__card">
                <h2 class="company__stitle">О компании</h2>
                <div class="company__stitle-underline"></div>
                <p class="company__desc">Компания SUPERTOUR.UZ создана с целью стать надежным источником информации и вдохновения для путешественников. Наша миссия - помочь людям открыть для себя красоту и разнообразие мира через увлекательные и запоминающиеся путешествия. Мы стремимся предоставить полезные путеводители, экспертные советы и актуальную информацию, чтобы каждое путешествие стало незабываемым приключением.</p>
            </div>
            <div class="company__card">
                <h2 class="company__stitle">Наши ценности</h2>
                <div class="company__stitle-underline"></div>
                <p class="company__desc">
                    Клиентоориентированность: Мы ставим потребности наших клиентов на первое место и делаем все возможное, чтобы превзойти их ожидания. <br> 
                    Профессионализм: Наша команда состоит из опытных и квалифицированных специалистов в сфере туризма, которые постоянно повышают свою квалификацию. <br> 
                    Инновативность: Мы всегда следим за новыми тенденциями в туристической индустрии и внедряем передовые технологии для улучшения качества наших услуг. <br> Ответственность: Мы ответственно подходим к организации каждой поездки, заботясь о безопасности и комфорте наших клиентов. <br> 
                </p>
            </div>
            <div class="company__card">
                <h2 class="company__stitle">Наши достижения</h2>
                <div class="company__stitle-underline"></div>
                <p class="company__desc">За годы работы мы зарекомендовали себя как надежного и ответственного партнера в сфере туризма. Мы гордимся тем, что наши клиенты неизменно остаются довольны нашими услугами, о чем свидетельствуют многочисленные положительные отзывы.</p>
            </div>
        </div>
    </section>
...
const images = ref([
    { src: require('../../assets/img/dubai.jpg'), alt: 'Image 1' },
    { src: require('../../assets/img/dubai2.jpg'), alt: 'Image 2' },
    { src: require('../../assets/img/dubai3.jpg'), alt: 'Image 3' },
    { src: require('../../assets/img/dubai.jpg'), alt: 'Image 4' },
    { src: require('../../assets/img/dubai.jpg'), alt: 'Image 4' },
    { src: require('../../assets/img/dubai2.jpg'), alt: 'Image 5' },
    { src: require('../../assets/img/dubai3.jpg'), alt: 'Image 6' },
    { src: require('../../assets/img/dubai3.jpg'), alt: 'Image 6' },
]);
